...
`wiki/` is the **LLM-wiki** markdown vault (index, log, concepts) for this service; `wiki/LLM_WIKI_SCHEMA.md` ties [Karpathy’s LLM-Wiki gist](https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f) and `docs/research/v2/s2-claude-plan.md` to REST usage. `raw/` will hold immutable ingest JSON once the pipeline is implemented.
