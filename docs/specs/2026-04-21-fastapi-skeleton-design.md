...
- Risk: endpoint shapes drift from the longer-term plan.
  - Mitigation: keep response keys aligned with `docs/research/v2/s2-claude-plan.md`.
...
- `docs/specs/2026-04-21-milestone-b-typed-models-settings-design.md`
- `docs/plans/2026-04-21-milestone-b-typed-models-settings.md`

Following Milestone B, introduce DB schema/migrations and ingest/query wiring incrementally per `docs/research/v2/s2-claude-plan.md`.
