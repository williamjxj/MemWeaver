...
This milestone bridges `docs/specs/2026-04-21-fastapi-skeleton-design.md` and the longer-term architecture in `docs/research/v2/s2-claude-plan.md` by making route contracts and app metadata **typed and documented in code**, while keeping handlers mock-only.

## Relationship to Other Docs

| Document | Role |
|----------|------|
| `docs/specs/2026-04-21-fastapi-skeleton-design.md` | Milestone A: single-file app, no settings module |
| **This spec** | Milestone B: `server/models`, `server/config`, typed routes |
| `docs/plans/2026-04-21-milestone-b-typed-models-settings.md` | Executable checklist for implementing this spec |
| `docs/research/v2/s2-claude-plan.md` | Target product: SQLite, FTS5, Ollama, markdown wiki (later milestones) |
...
## Alignment with `docs/research/v2/s2-claude-plan.md`
...
- Persist Q/A and wiki artifacts (SQLite + markdown paths per `docs/research/v2/s2-claude-plan.md`).
