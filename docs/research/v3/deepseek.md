...
> **Based on:** codebase audit + three vision docs (`docs/research/v2/s2-claude-plan.md`, `docs/2nd-brain-implementation.md`, `docs/architecture-decision-inspiration.md`).
...
*Plan references: docs/research/v2/s2-claude-plan.md, docs/2nd-brain-implementation.md, docs/architecture-decision-inspiration.md*  
